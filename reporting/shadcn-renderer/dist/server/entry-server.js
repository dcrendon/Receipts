    ...
    children: [
      /* @__PURE__ */ jsxs("head", {
        children: [
          ...
          /* @__PURE__ */ jsx("title", {
            children: "Activity Report (ShadCN Package)",
          }),
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              href:
                "https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;700&display=swap",
              rel: "stylesheet",
            },
          ),
          /* @__PURE__ */ jsx("style", {
      ...
      /* @__PURE__ */ jsx("body", {
        children: /* @__PURE__ */ jsxs("main", {
          ...
          children: [
            /* @__PURE__ */ jsx(Card, {
              className: "hero border-border/70 bg-card/95",
                      ...
                      /* @__PURE__ */ jsxs("div", {
                        children: [
                          /* @__PURE__ */ jsx("h1", {
                            ...
                            children: "Engineering Activity Report",
                          }),
                          /* @__PURE__ */ jsxs("p", {
                            className: "hero-meta",
                            children: [
                          ...
                          /* @__PURE__ */ jsx("p", {
                            className: "headline",
                            children: narrative.executiveHeadline,
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsxs("aside", {
                ...
                /* @__PURE__ */ jsxs(CardContent, {
                  children: [
                    /* @__PURE__ */ jsx("ul", {
                      ...
                      children: IMPACT_LEGEND_ITEMS.map((item) =>
                        /* @__PURE__ */ jsx("li", { children: item }, item)
                      ),
                    }),
                    /* @__PURE__ */ jsxs("div", {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("p", {
                          className: "score-inputs-label",
                          children: "Score inputs:",
                        }),
                        /* @__PURE__ */ jsx("ul", {
                          className: "score-inputs-list",
                          children: IMPACT_SCORE_INPUT_ITEMS.map((item) =>
                            /* @__PURE__ */ jsx("li", { children: item }, item)
                          ),
                        }),
                      ],
            ...
            /* @__PURE__ */ jsxs(Card, {
              children: [
                ...
                /* @__PURE__ */ jsx(CardContent, {
                  children: summary.topActivityHighlights.length === 0
                    ? /* @__PURE__ */ jsx("p", {
                      className: "empty-state",
                      children: "No highlights selected.",
                    })
                    : /* @__PURE__ */ jsx("div", {
                      className: "issue-grid",
                      children: summary.topActivityHighlights.map(
                        (issue, index) => {
                          const wording =
                                ...
                                children: [
                                  /* @__PURE__ */ jsxs("div", {
                                    ...
                                    children: [
                                      /* @__PURE__ */ jsx("p", {
                                        className:
                                          "mono text-[11px] uppercase tracking-[0.12em] text-muted-foreground",
                                        children:
                                  ...
                                  /* @__PURE__ */ jsxs("h3", {
                                    ...
                                    children: [
                                      ...
                                      /* @__PURE__ */ jsx("span", {
                                        className:
                                          "ml-1 font-medium text-foreground/85",
                                  ...
                                  /* @__PURE__ */ jsx("p", {
                                    className: "issue-copy text-sm",
                                    children: wording,
                                  }),
                                  /* @__PURE__ */ jsxs("div", {
                                    className: "issue-pill-row",
                                    children: [
                                      /* @__PURE__ */ jsx(
                                        Badge,
                                        {
                                          className:
                                            BUCKET_BADGE_CLASS[issue.bucket],
                                          variant: "outline",
                                      ...
                                      contribution
                                        ...
                                        : /* @__PURE__ */ jsx(Badge, {
                                          variant: "outline",
                                          children: "no direct attribution",
                                        }),
                                    ],
                                  }),
                                  issue.labels.length
                                    ? /* @__PURE__ */ jsx("div", {
                                      className: "issue-label-row",
            ...
            /* @__PURE__ */ jsxs(Card, {
              children: [
                /* @__PURE__ */ jsx(CardHeader, {
                  children: /* @__PURE__ */ jsx(CardTitle, {
                    className: "section-title",
                    children: "Collaboration Highlights",
                  }),
                }),
                /* @__PURE__ */ jsx(CardContent, {
                  children: /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                        ...
                        children: /* @__PURE__ */ jsxs(CardHeader, {
                          children: [
                            /* @__PURE__ */ jsx(CardDescription, {
                              children: "Total collaborative issues",
                            }),
                            /* @__PURE__ */ jsx(CardTitle, {
                              className: "mono text-5xl",
                              children: summary.contribution.contributedIssues,
                            }),
                          ],
                        }),
                      }),
                      /* @__PURE__ */ jsx("ul", {
                        ...
                        children: narrative.collaborationHighlights.length
                          ? narrative.collaborationHighlights.map((
                            line,
                            index,
                          ) =>
                            /* @__PURE__ */ jsx("li", {
            ...
            /* @__PURE__ */ jsxs(Card, {
              children: [
                /* @__PURE__ */ jsx(CardHeader, {
                  children: /* @__PURE__ */ jsx(CardTitle, {
                    className: "section-title",
                    children: "Risks and Follow-ups",
                  }),
                }),
                /* @__PURE__ */ jsx(CardContent, {
                  children: /* @__PURE__ */ jsx("ul", {
                    className: "risk-list",
                    children: narrative.risksAndFollowUps.length
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx(Card, {
                              ...
                              children: /* @__PURE__ */ jsxs(CardContent, {
                                ...
                                children: [
                                  /* @__PURE__ */ jsx("p", {
                                    className: "risk-context",
                                    children: parsed.context,
                                  }),
                                  /* @__PURE__ */ jsx("p", {
                                    className: "risk-action",
                                    children: parsed.action,
                                  }),
                                ],
                              }),
                            }),
                      ...
                      : /* @__PURE__ */ jsx("li", {
                        className: "empty-state",
                        children: "No immediate follow-up actions required.",
                      }),
                  }),
                }),
              ],
            ...
            /* @__PURE__ */ jsxs(Card, {
              children: [
                ...
                /* @__PURE__ */ jsx(CardContent, {
                  children: narrative.weeklyTalkingPoints.length
                    ? /* @__PURE__ */ jsx("div", {
                      className: "talk-grid",
                      children: narrative.weeklyTalkingPoints.map((
                        point,
                        index,
                      ) =>
                        /* @__PURE__ */ jsxs(
                          Card,
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsx(CardContent, {
                                className: "pt-0",
                                children: point.bullets.length
                                  ? /* @__PURE__ */ jsx("ul", {
                                    className:
                                      "talk-list list-disc space-y-0.5 pl-5 text-sm text-muted-foreground",
                                    children: point.bullets.map((
                                      bullet,
                                      bulletIndex,
                                    ) =>
                                      /* @__PURE__ */ jsx("li", {
                    ...
                    : /* @__PURE__ */ jsx("p", {
                      className: "empty-state",
                      children: "No talking points generated.",
                    }),
                }),
              ],
            }),
                    ...
                    children: /* @__PURE__ */ jsxs(Table, {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(TableBody, {
                          children: normalizedIssues.length
                              ...
                              /* @__PURE__ */ jsxs(
                                TableRow,
                                {
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsx(TableCell, {
                                      children: PROVIDER_LABEL[issue.provider],
                                    }),
                                    /* @__PURE__ */ jsx(TableCell, {
                                    ...
                                    /* @__PURE__ */ jsx(TableCell, {
                                      className: "mono",
                                      children: issue.impactScore,
                                    }),
                                    /* @__PURE__ */ jsx(TableCell, {
                                      children: formatHumanDateTime(
                                        issue.updatedAt,
                                      ),
                                    }),
                                    /* @__PURE__ */ jsx(TableCell, {
                                      className: "mono",
                                      children: issue.isAuthoredByUser
                                        ? "yes"
                                        : "no",
                                    }),
                                    /* @__PURE__ */ jsx(TableCell, {
                                      className: "mono",
                                      children: issue.isAssignedToUser
                                        ? "yes"
                                        : "no",
                                    }),
                                    /* @__PURE__ */ jsx(TableCell, {
                                      className: "mono",
                                      children: issue.isCommentedByUser
                                        ? "yes"
                                        : "no",
                                    }),
                                  ],
...
async function main() {
  ...
  const html = "<!doctype html>" +
    renderToStaticMarkup(/* @__PURE__ */ jsx(ReportDocument, { payload }));
